	...
	function kafco_common_sidebar() {
     ...
     <div class="sidenav-info">
        ...
        <div class="sidenav">
            ...
            <a href="<?php echo get_the_permalink(pll_get_post(get_page_by_path( 'fuel-upliftment-summary' )->ID)); ?>" <?php if(is_page('fuel-upliftment-summary')) echo 'class="active"'; ?>><img src="<?php echo KAFCO_INC_URL . '/images/fuel.svg' ?>"> <?php echo kafco_plugin_str_display('Fuel Uplift Summary'); ?></a>
