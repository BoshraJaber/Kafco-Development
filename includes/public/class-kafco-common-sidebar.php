	...
	function kafco_common_sidebar() {
     ...
     <div class="sidenav-info">
        ...
        <div class="sidenav">
            ...
            <a href="<?php echo get_the_permalink(pll_get_post(get_page_by_path( 'satisfaction-survey' )->ID)); ?>" <?php if(is_page('satisfaction-survey')) echo 'class="active"'; ?>><img src="<?php echo KAFCO_INC_URL . '/images/survey.svg' ?>"> <?php echo kafco_plugin_str_display('Satisfaction Survey'); ?></a>
