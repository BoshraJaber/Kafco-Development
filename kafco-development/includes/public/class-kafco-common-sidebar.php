	...
	function kafco_common_sidebar() {
     ...
     <div class="sidenav-info">
        ...
        <div class="sidenav">
            ...
            <a href="#"><img src="<?php echo KAFCO_INC_URL . '/images/status.svg' ?>"> <?php echo kafco_plugin_str_display('Status'); ?></a>
            ...
            <a href="#"><img src="<?php echo KAFCO_INC_URL . '/images/fuel.svg' ?>"> <?php echo kafco_plugin_str_display('Fuel Uplift Summary'); ?></a>
            <a href="#"><img src="<?php echo KAFCO_INC_URL . '/images/fuel-prices.svg' ?>"> <?php echo kafco_plugin_str_display('Fuel Prices'); ?></a>
